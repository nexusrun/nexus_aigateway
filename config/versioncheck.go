...
// VersionCheckConfig controls the daily update check against the AIGateway
// release manifest.
//
...
type VersionCheckConfig struct {
	...
	// Default: true
	Enabled bool `yaml:"enabled" env:"AIGATEWAY_VERSION_CHECK_ENABLED,GOMODEL_VERSION_CHECK_ENABLED"`
	...
	URL string `yaml:"url" env:"AIGATEWAY_VERSION_CHECK_URL,GOMODEL_VERSION_CHECK_URL"`
	...
	// Default: 24
	IntervalHours int `yaml:"interval_hours" env:"AIGATEWAY_VERSION_CHECK_INTERVAL_HOURS,GOMODEL_VERSION_CHECK_INTERVAL_HOURS"`

	// TimeoutSeconds bounds a single manifest request.
	// Default: 5
	TimeoutSeconds int `yaml:"timeout_seconds" env:"AIGATEWAY_VERSION_CHECK_TIMEOUT_SECONDS,GOMODEL_VERSION_CHECK_TIMEOUT_SECONDS"`
	...
	// Default: 500
	MaxDailyChecks int `yaml:"max_daily_checks" env:"AIGATEWAY_VERSION_CHECK_MAX_DAILY,GOMODEL_VERSION_CHECK_MAX_DAILY"`
}

// DefaultVersionCheckURL is the public release manifest served by the AIGateway
