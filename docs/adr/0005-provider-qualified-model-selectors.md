...
AIGateway supports multiple configured providers.
...
then AIGateway treats it as an unqualified model lookup.
...
If the request has a slash, AIGateway splits on the first slash only.
