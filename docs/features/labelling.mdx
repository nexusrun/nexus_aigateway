...
<img
  ...
  alt="AIGateway dashboard API Keys page with a Labels column showing chips like env:demo, team:engineering, and priority:high for each key"
...
<img
  ...
  alt="AIGateway dashboard Settings page Tagging based on headers form with two header rows (X-Team, X-Environment) and prefix, delimiter, and do-not-pass-upstream fields"
