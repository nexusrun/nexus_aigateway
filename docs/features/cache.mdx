---
title: "Cache"
description: "How AIGateway response caching works, how to enable exact and semantic cache layers, and what is included in the exact-cache key."
icon: "database"
...
AIGateway ships with two response-cache layers for streaming and non-streaming
requests on:
...
After routing resolves the concrete provider and model, AIGateway adds a cache
...
Provider prompt-cache planning is enabled by default. To disable AIGateway's
