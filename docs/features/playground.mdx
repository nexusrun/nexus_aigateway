...
The header name is `X-AIGateway-User-Path` by default. If you customize it through
...
<img
  ...
  alt="AIGateway dashboard Playground page with the Messages endpoint selected, a model picker, System, User, and Assistant message cards, a prompt composer, and the request JSON panel on the right"
