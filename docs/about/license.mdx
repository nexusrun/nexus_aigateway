---
title: "License"
description: "The current AIGateway license and how we think about long-term project sustainability."
icon: "scale"
...
AIGateway is released under the permissive MIT license. We want to keep it open
and practical for developers, small teams, and independent projects.

Two qualifications:

1. The commercial distribution, [AIGateway Pro](/pro/overview), adds licensed
   features on top of the same
...
you can read, audit, extend, and trust. This is why AIGateway is open source
today.
...
If AIGateway grows to a point where this becomes a real risk, we may adjust the
license to prevent that kind of extraction.

### Sustainability

Building AIGateway is how we make a living, and so far it has not paid for
itself. That is why the commercial distribution, [AIGateway Pro](/pro/overview),
with licensed extensions, is available. The gateway is
...
<Card
  ...
  icon="scale"
  href="https://github.com/nexusrun/nexus_aigateway/blob/main/LICENSE"
>
