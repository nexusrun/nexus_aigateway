...
description: "The engineering ideas behind AIGateway: Postel's law at the gateway boundary, defaults that work with no setup, and a Twelve-Factor influence."
icon: "brain"
...
As an AI gateway, AIGateway sits between clients and providers that do not always
...
AIGateway should be useful with minimal setup.
