...
commercial distribution, [AIGateway Pro](/pro/overview), with licensed
extensions including OIDC SSO, is available; it accounts for roughly 3% of the
codebase.
...
feature, is on the table. Ask on
