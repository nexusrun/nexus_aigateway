...
description: "Configure Gemini on Google Vertex AI in AIGateway, including ADC and service-account authentication, regions, and native vs OpenAI-compatible routing."
...
Application Default Credentials or a service-account JSON key. AIGateway routes
