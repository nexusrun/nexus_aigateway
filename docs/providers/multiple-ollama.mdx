---
title: "Ollama"
description: "Use one AIGateway instance with multiple Ollama providers through suffixed environment variables and provider-qualified model IDs."
icon: "network"
keywords: ["Ollama", "local models", "self-hosted", "multiple providers"]
---

AIGateway registers Ollama through `OLLAMA_BASE_URL`. To run multiple Ollama
