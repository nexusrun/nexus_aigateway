---
title: "Hetzner"
description: "Configure Hetzner's experimental OpenAI-compatible inference API in AIGateway."
icon: "server"
...
`https://inference.hetzner.com/api/v1`. AIGateway routes chat, model listing, and
...
AIGateway also exposes this list through its own `/v1/models` endpoint once the provider
...
notify users by email before billing begins. AIGateway's usage-cost tracking reports `cost`
