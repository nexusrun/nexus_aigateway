---
title: "Oracle GenAI"
description: "Configure Oracle GenAI's OpenAI-compatible endpoint in AIGateway, including the required OCI policy and configured model lists."
icon: "/brand/oracle.svg"
keywords: ["Oracle GenAI", "OCI", "provider setup"]
---

AIGateway calls Oracle Generative AI through Oracle's OpenAI-compatible inference
