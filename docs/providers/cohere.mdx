---
title: "Cohere"
description: "Configure Cohere in AIGateway and use Command chat, tool calling, reasoning, image input, audio transcription, and Embed models through OpenAI-compatible APIs."
icon: "message-circle"
keywords: ["Cohere", "Command models", "Embed", "tool calling", "provider setup"]
---

AIGateway translates OpenAI-compatible Chat Completions, Responses, Embeddings,
...
The Cohere transcription API requires `language` and returns JSON. AIGateway
...
AIGateway supplies Cohere's required embedding fields while retaining the
...
not have an OpenAI-compatible AIGateway surface.
