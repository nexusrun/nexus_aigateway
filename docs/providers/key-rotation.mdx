...
Configure more than one and AIGateway spreads identified sessions across them. Each
...
Every call AIGateway makes to the provider uses the same selection policy: chat
