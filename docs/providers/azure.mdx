---
title: "Azure OpenAI"
description: "Configure Azure OpenAI in AIGateway using deployment-based URLs and the api-version query parameter."
icon: "/brand/azure.svg"
keywords: ["Azure OpenAI", "deployment", "api-version", "provider setup"]
---

Azure OpenAI speaks the OpenAI API shape with two AIGateway-handled differences:
...
- AIGateway accepts the deployment-scoped URL the portal hands you. For
  account-wide operations (model listing, batches) AIGateway strips the
