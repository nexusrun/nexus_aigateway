---
title: "Kimi Code"
description: "Configure Kimi Code in AIGateway and understand its model alias, embeddings caveat, and quota behavior."
icon: "code"
...
AIGateway routes chat, model listing, embeddings, and passthrough requests through the shared
...
Kimi Code does not publish per-token pricing. Because AIGateway's usage-cost tracking has
