...
icon: "package-minus"
tag: "Pro"
keywords: ["AIGateway Pro", "prompt compression", "token savings", "deduplication", "prompt cache"]
---
...
```http
X-AIGateway-Pro-Tokens-Saved: 1843
X-AIGateway-Pro-Compression-Blocks: 12
```
...
`aigateway_pro_compression_` prefix, and the Dashboard Usage page reports Pro
