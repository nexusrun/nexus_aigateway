...
description: "AIGateway Pro adds licensed prompt compression, intelligent routing, and OIDC SSO to the AIGateway gateway."
icon: "gem"
tag: "Pro"
keywords: ["AIGateway Pro", "prompt compression", "intelligent routing", "OIDC", "SSO", "quota templates", "license"]
---

## What Pro is

AIGateway Pro is the commercial distribution of AIGateway. It uses the same
gateway, configuration, providers, dashboard, and APIs as open-source
AIGateway, with licensed extensions for prompt compression, intelligent routing,
...
`AIGATEWAY_PRO_LICENSE`. Validation requires no network access and works in
